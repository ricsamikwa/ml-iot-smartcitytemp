...
exp_final_temp, exp_tran_dataset = utils.create_training_data_with_pre_padding_exp(dataset, 137)
...
# save to npy file ############# exp 2
save('dataset/exp_final_temp2.npy', exp_final_temp)
save('dataset/exp_tran_dataset2.npy', exp_tran_dataset)
